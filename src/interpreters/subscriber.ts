...
> {
  #subscriber: FnSubReduced<E, A, Tc, void>;
   ...
   */
  #equals: (
    previous: State<Tc, ToEvents2<E, A>, A>,
    next: State<Tc, ToEvents2<E, A>, A>,
  ) => boolean;
  ...
  constructor(
    ...
    subscriber: FnSubReduced<E, A, Tc, void>,
    equals: (
      a: State<Tc, ToEvents2<E, A>, A>,
      b: State<Tc, ToEvents2<E, A>, A>,
    ) => boolean = equal,
    private _id = nanoid(),
  ) {
  ...
  get #reduceFn() {
    ...
    return ({ event, ...rest }: State<Tc, ToEvents2<E, A>, A>) => {
