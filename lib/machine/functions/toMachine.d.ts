...
export type ToMachine_F = <E extends EventsMap, P extends PromiseeMap = PromiseeMap, Tc extends types.PrimitiveObject = types.PrimitiveObject>(machine: ActionConfig, machines?: MachineMap<E, P, Tc>) => (ChildS<E, P, Tc> & {
    id: string;
}) | undefined;
/**
 ...
 */
export declare const toMachine: ToMachine_F;
//# sourceMappingURL=toMachine.d.ts.map