import type { Action, FromActionConfig } from '../actions/index.js';
...
type _GetKeyActionsFromFlat<Flat extends FlatMapN> = {
    [key in keyof Flat]: ExtractActionKeysFromTransitions<Extract<Flat[key], TransitionsConfig>> | ExtractActionsFromActivity<Extract<Flat[key], {
        activities: ActivityConfig;
    }>> | FromActionConfig<ReduceArray<Extract<Flat[key], {
        entry: any;
    }>['entry']>> | FromActionConfig<ReduceArray<Extract<Flat[key], {
        exit: any;
    }>['exit']>> extends infer V ? unknown extends V ? never : V : never;
}[keyof Flat];
/**
...
type _GetKeyGuardsFromFlat<Flat extends FlatMapN> = {
    [key in keyof Flat]: ExtractGuardKeysFromTransitions<Extract<Flat[key], TransitionsConfig>> | ExtractGuardsFromActivity<Extract<Flat[key], {
        activities: ActivityConfig;
    }>> extends infer V ? unknown extends V ? never : V : never;
}[keyof Flat];
/**
...
type _GetKeySrcFromFlat<Flat extends FlatMapN> = {
    [key in keyof Flat]: ExtractSrcFromTransitions<Extract<Flat[key], TransitionsConfig>> extends infer V ? unknown extends V ? never : V : never;
}[keyof Flat];
/**
...
type _GetEventKeysFromFlat<Flat extends FlatMapN> = {
    [key in keyof Flat]: Flat[key] extends {
        on: infer V;
    } ? keyof V : never;
}[keyof Flat];
/**
...
type _GetDelayKeysFromFlat<Flat extends FlatMapN> = {
    [key in keyof Flat]: ExtractDelayKeysFromTransitions<Extract<Flat[key], TransitionsConfig>> | ExtractDelaysFromActivity<Flat[key]> extends infer V ? unknown extends V ? never : V : never;
}[keyof Flat];
/**
 ...
 */
export type GetEventsFromFlat<Flat extends FlatMapN> = Record<_GetEventKeysFromFlat<Flat>, types.PrimitiveObject>;
/**
 ...
 */
export type GetEventsFromConfig<C extends Config> = GetEventsFromFlat<FlatMapN<C>>;
export type GetTargetsFrom<C extends Config> = GetTargetsFromMap<FlatMapN<C>>;
/**
 ...
 */
export type GetPromiseeSrcFromFlat<Flat extends FlatMapN> = Record<_GetKeySrcFromFlat<Flat>, PromiseeDef>;
/**
 ...
 */
export type GetPromiseeSrcFromConfig<C extends Config> = GetPromiseeSrcFromFlat<FlatMapN<C>>;
/**
 ...
 */
export type GetMachineKeysFromConfig<C extends Config> = FromActionConfig<ReduceArray<types.NotUndefined<C['machines']>>>;
/**
 * Second version decomposition of a type.
 */
export type Decompose2<T> = T extends types.Ru ? Decompose<types.DeepRequired<T>> : never;
type HeritageMap<U extends types.Ru, Tc extends types.Ru> = Decompose<U, {
    start: false;
    object: 'both';
}> extends infer KU extends object ? {
    [key in keyof KU]?: Decompose<Tc, {
        start: false;
    }> extends infer KT extends object ? SingleOrArrayL<keyof types.SubType<KT, KU[key]>> : never;
} : never;
/**
...
} & (ContextFrom<U> extends infer CU ? CU extends TrueObject ? Pc extends TrueObject ? {
    contexts: SingleOrArrayL<HeritageMap<CU, Pc>>;
} : SubNev : CU extends types.Primitive ? Pc extends CU ? SubNev : Pc extends infer Tc1 extends TrueObject ? {
    contexts: SingleOrArrayL<types.AllowedNames<Decompose<Tc1, {
        start: false;
    }>, CU>>;
} : SubNev : SubNev : SubNev);
/**
 ...
 */
export type FnMapFrom<T extends KeyU<'eventsMap' | 'pContext' | 'context' | 'promiseesMap'>, R = any> = FnMap2<Extract<EventsMapFrom<T>, EventsMap>, Extract<PromiseesMapFrom<T>, PromiseeDef>, Extract<ContextFrom<T>, types.PrimitiveObject>, R>;
/**
 ...
 */
export type MachineOptionsFrom<T extends KeyU<'options'>> = Extract<T['options'], SimpleMachineOptions2>;
/**
 ...
 */
export type ContextFrom<T extends KeyU<'context'>> = Extract<T['context'], types.PrimitiveObject>;
/**
 ...
 */
export type EventsMapFrom<T extends KeyU<'eventsMap'>> = Extract<T['eventsMap'], EventsMap>;
/**
 ...
 */
export type StateExtendedFrom<T extends KeyU<'__stateExtended'>> = T['__stateExtended'];
 ...
 */
export type StatePextendedFrom<T extends KeyU<'__statePextended'>> = T['__statePextended'];
/**
 ...
 */
export type PromiseesMapFrom<T extends KeyU<'promiseesMap'>> = Extract<T['promiseesMap'], PromiseeMap>;
/**
 ...
 */
export type ActionsMapFrom<T extends KeyU<'actions'>> = types.NotUndefined<T['actions']>;
/**
 ...
 */
export type ActionFnFrom<T extends KeyU<'__actionFn'>> = types.NotUndefined<T['__actionFn']>;
/**
 ...
 */
export type ActionParamsFrom<T extends KeyU<'__actionParams'>> = types.NotUndefined<T['__actionParams']>;
/**
 ...
 * @see {@linkcode types.NotUndefined}
 */
export type PredicatesMapFrom<T extends KeyU<'predicates'>> = types.NotUndefined<T['predicates']>;
/**
 ...
 */
export type PredicateSFrom<T extends KeyU<'__predicate'>> = types.NotUndefined<T['__predicate']>;
/**
 ...
 */
export type DelaysMapFrom<T extends KeyU<'delays'>> = types.NotUndefined<T['delays']>;
/**
 ...
 */
export type DelayFnFrom<T extends KeyU<'__delay'>> = types.NotUndefined<T['__delay']>;
/**
 ...
 */
export type PromisesMapFrom<T extends KeyU<'promises'>> = types.NotUndefined<T['promises']>;
/**
 ...
 */
export type PromiseKeysFrom<T extends KeyU<'__src'>> = types.NotUndefined<T['__src']>;
/**
 ...
 */
export type MachinesMapFrom<T extends KeyU<'machines'>> = types.NotUndefined<T['machines']>;
/**
