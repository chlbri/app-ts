 ...
 */
type _ExtractActionsFromMap<T> = ExtractActionsFromTransition<Extract<types.ReduceArray<types.NotUndefined<T>>, {
 ...
 */
export type ExtractActionsFromFinally<T extends FinallyConfig> = types.ReduceArray<T> extends infer Tr ? Tr extends ActionConfig ? FromActionConfig<Tr> : _ExtractActionsFromMap<Tr> : never;
/**
 ...
 */
export type ExtractActionsFromPromisee<T extends PromiseeConfig> = _ExtractActionsFromMap<T['then']> | _ExtractActionsFromMap<T['catch']> | ExtractActionsFromFinally<types.NotUndefined<T['finally']>>;
/**
 ...
 */
export type ExtractSrcFromPromisee<T extends {
    src: string;
}> = T['src'];
/**
 ...
 */
export type ExtractMaxFromPromisee<T extends {
    max: string;
}> = T['max'];
/**
 ...
 */
export type ExtractGuardsFromPromise<T extends PromiseeConfig> = ExtractGuardKeysFromDelayed<T['then']> | ExtractGuardKeysFromDelayed<T['catch']> | ExtractGuardKeysFromDelayed<T['finally']>;
/**
 * A big one !
 *
 ...
 */
export type PromiseeResult<E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap> = {
    event: ToEvents<E, P>;
    target: string | false;
};
export {};
