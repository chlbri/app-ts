...
type ToPromise_F = <E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, TC extends types.PrimitiveObject = types.PrimitiveObject>(events: E, promisees: P, src: PromiseeConfig, promises?: SimpleMachineOptions<E, P, Pc, TC>) => Promisee<E, P, Pc, TC>;
/**
