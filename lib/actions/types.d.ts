...
export type Action<E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = FnMap<E, P, Pc, Tc, ActionResult<Pc, Tc>>;
/**
 ...
 */
export type ActionMap<E extends EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = Partial<Record<string, Action<E, P, Pc, Tc>>>;
export type ActionResultFn<E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = FnR<E, P, Pc, Tc, ActionResult<Pc, Tc>>;
/**
 ...
 */
export type ActionResult<Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = types.DeepPartial<{
    pContext: Pc;
    context: Tc;
}>;
export type Action2<E extends EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = ActionResultFn<E, P, Pc, Tc>;
