...
export type ToAction_F<E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = (action?: ActionConfig) => Action2<E, P, Pc, Tc>;
export type PerformActionLater_F<E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = (action: Action2<E, P, Pc, Tc>) => ActionResult<Pc, Tc>;
export type PerformAction_F<E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = (action: Action2<E, P, Pc, Tc>) => void;
export type ToPredicate_F<E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = (predicate?: GuardConfig) => PredicateS2<E, P, Pc, Tc>;
export type PerformPredicate_F<E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = (predicate: PredicateS2<E, P, Pc, Tc>) => boolean;
export type ToDelay_F<E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = (delay?: string) => FnR<E, P, Pc, Tc, number> | undefined;
export type PerformDelay_F<E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = (delay: FnR<E, P, Pc, Tc, number>) => number;
export type PerformPromise_F<E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = (promise: PromiseFunction2<E, P, Pc, Tc>) => Promise<any>;
...
export type TransitionAfterResult<Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = {
...
export type ToPromiseSrc_F<E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = (promise: string) => PromiseFunction2<E, P, Pc, Tc>;
...
export type Contexts<Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> = {
    pContext?: Pc;
    context?: Tc;
};
...
export type StateExtended<Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject, E extends AllEvent = AllEvent> = {
    pContext: Pc;
} & State<Tc, E>;
export type StatePextended<Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject, E = any> = {
    pContext: Pc;
} & StateP<Tc, E>;
...
export interface AnyInterpreter<E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject> {
    mode: Mode;
    event: ToEvents<E, P>;
    eventsMap: EventsMap;
