...
import { isCompound } from './checks/isCompound.js';
import { isAtomic } from './checks/isAtomic.js';
...
const nodeToValue = body => {
    ...
    const entries2 = entries.map(([key, value]) => castings.arrays.tupleOf(key, nodeToValue(value)));
...
export { nodeToValue };
//# sourceMappingURL=nodeToValue.js.map
