...
export type ResolveNode_F = <E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap, Pc = any, Tc extends types.PrimitiveObject = types.PrimitiveObject>(events: E, promisees: P, config: NodeConfig, options?: types.NOmit<SimpleMachineOptions<E, P, Pc, Tc>, 'initials'>) => Node<E, P, Pc, Tc>;
/**
