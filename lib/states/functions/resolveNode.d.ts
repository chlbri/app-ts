...
export type ResolveNode_F = <E extends EventsMap = EventsMap, P extends PromiseeMap = PromiseeMap, Pc extends types.PrimitiveObject = types.PrimitiveObject, Tc extends types.PrimitiveObject = types.PrimitiveObject>(events: E, promisees: P, config: NodeConfigWithInitials, options?: types.NOmit<SimpleMachineOptions<E, P, Pc, Tc>, 'initials'>) => Node<E, P, Pc, Tc>;
/**
